...
function ServicesSection() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ServicesSection.useEffect": ()=>{
                    ...
                    entries.forEach({
                        "ServicesSection.useEffect": (entry)=>{
                            if (entry.isIntersecting) {
                                ...
                                setVisibleCards({
                                    "ServicesSection.useEffect": (prev)=>[
                                            ...new Set([
                                                ...prev,
                                                index
                                            ])
            ...
            cards?.forEach({
                "ServicesSection.useEffect": (card)=>observer.observe(card)
            }["ServicesSection.useEffect"]);
            return ({
...
_s(ServicesSection, "Nfa6iSbszDCZbj/Rch3X9CxzjMY=");
_c = ServicesSection;
var _c;
...
function PortfolioSection() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "PortfolioSection.useEffect": ()=>{
                    ...
                    entries.forEach({
                        "PortfolioSection.useEffect": (entry)=>{
                            if (entry.isIntersecting) {
                                const index = Number.parseInt(entry.target.getAttribute("data-index") || "0");
                                setVisibleCards({
                                    "PortfolioSection.useEffect": (prev)=>[
                                            ...new Set([
                                                ...prev,
                                                index
                                            ])
            ...
            const cards = sectionRef.current?.querySelectorAll("[data-index]");
            cards?.forEach({
                "PortfolioSection.useEffect": (card)=>observer.observe(card)
            }["PortfolioSection.useEffect"]);
            return ({
...
_s(PortfolioSection, "AimFZYZw+bAjJy75s5Ya1glxm+0=");
_c = PortfolioSection;
var _c;
...
_s(ContactSection, "XWAJ22PCtZ2EQA4eKsMhj9dCGcs=");
_c = ContactSection;
var _c;
...
//# sourceMappingURL=_696b888d._.js.map